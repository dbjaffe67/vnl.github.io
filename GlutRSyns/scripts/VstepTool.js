...
function vstepaParams(){
	...
	var st2 = "<input id='vhValue' type='text' value='-80' class='inform' onChange='setVh(this.value)'>mV  &nbsp; &nbsp;&nbsp;";
	var st3 = "Duration <input class='rangeH' min='5' max='100' step='5' value='20' onchange='sethDur(this.value)'  autofocus='' id='vhdurslide' type='range'>";
